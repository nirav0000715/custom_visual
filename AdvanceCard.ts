...
export class AdvanceCard {
    ...
    private titleHeight: Selection<BaseType, any, any, any>;
    ...
    public updateDataLabelTransform() {
        ...
        this.dataLabelGroupElement.attr("transform", translate(x, y + parseInt(this.settings.dataLabelSettings.spacinght)));
    }
    ...
    public updatePrefixLabelTransform() {
        ...
        this.prefixLabelGroupElement.attr("transform", translate(x, y + parseInt(this.settings.prefixSettings.spacinght) ));
    }
    ...
    public updatePostfixLabelTransform() {
        ...
        this.postfixLabelGroupElement.attr("transform", translate(x, y + parseInt(this.settings.postfixSettings.spacinght)));
    }
    ...
    private getYForTopRow() {
        ...
        let dataLabelSize = getLabelSize(this.dataLabelGroupElement);
        let categoryLabelSize = getLabelSize(this.categoryLabelGroupElement);
        let titleSize = getLabelSize(this.titleHeight);
        if (this.settings.categoryLabelSettings.show) {
            ...
            y =  15 // 20//131/4 ;//this.rootSVGSize.height/4 ; //(0 - dataLabelSize.y) + (this.rootSVGSize.height - dataLabelSize.height) / 2;
        }
        return y;
    }
